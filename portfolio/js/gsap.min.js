...
!(function(t, e) {
            ...
            function(t, e, r) {
                ...
                if (!p) {
                    if (!(f = "auto" === c.grid ? 0 : (c.grid || [1, j])[1])) {
                        for (
                            h = -j; h < (h = r[f++].getBoundingClientRect().left) && f < d;
                        ...
                        if (
                            ...
                            if (
                                (s < d && (b = !b),
                                    ...
                                    (this._tTime = v), !e && this.parent && Mt(this, "onRepeat"),
                    ...
                    if (
                        (this._hasPause &&
                            ...
                            ((this._onUpdate = this.vars.onUpdate),
                                (this._initted = 1),
                                (this._zTime = t),
                                (_ = 0)), !_ && i && !e && (Mt(this, "onStart"), this._tTime !== v))
                    )
                        return this;
                    if (_ <= i && 0 <= t)
                        for (n = this._first; n;) {
        ...
        if (
            ...
            (u = new ft[t]()).init(
                ...
                (function _processVars(t, e, r, i, n) {
                    if (
                        (p(t) && (t = Xt(t, n, e, r, i)), !s(t) || (t.style && t.nodeType) || W(t) || H(t))
                    )
        ...
        jt = function _initTween(e, r) {
            ...
            if (
                (!B || (C && v) || (v = "none"),
                    ...
                    (e._from = !B && !!g.runBackwards), !B || (C && !g.stagger))
            ) {
                if (
                ...
                for (
                    e._pt = 0, T = (A && t(T)) || (T && !A), n = 0; n < D.length; n++
                ) {
                    if (
        ...
        function Tween(e, r, i, n) {
            ...
            if (
                ((a._targets = P.length ?
                        $(P) :
                        O(
                            "GSAP target " + e + " not found. https://greensock.com", !Y.nullTargetWarn
                        ) || []),
                    (a._ptLookup = []),
                    (a._overwrite = T),
                    w || b || v(m) || v(g))
                ...
                if (
                    ...
                    for (u = 0; u < l; u++)
                        ...
                        (h.delay =
                            (+Xt(g, _assertThisInitialized(a), u, d, P) || 0) - a._delay), !b &&
                        1 === l &&
                        h.delay &&
                    ...
                    if (
                        ...
                        if (((i = _), (l = this.timeline), this._repeat)) {
                            ...
                            if (
                                ...
                                return this;
                            a !== o &&
                                (l && this._yEase && Hb(l, u), !this.vars.repeatRefresh ||
                                    u ||
                                    this._lock ||
                                    ((this._lock = r = 1),
                        ...
                        this._onUpdate &&
                            ...
                            (t < 0 &&
                                ...
                                (t < 0 && !d) ||
                                (!_ && !d) ||
                                (Mt(this, _ === p ? "onComplete" : "onReverseComplete", !0), !this._prom ||
    ...
    function wd(e) {
        ...
        return (
            (r && (r.width || r.height)) || e.getBBox === ud || (r = ud.call(e, !0)), !r || r.width || r.x || r.y ?
            r :
            {
                x: +vd(e, ["x", "cx", "x1"]) || 0,
                y: +vd(e, ["y", "cy", "y1"]) || 0,
        ...
        return i === h || !u || Ue[i] || Ue[h] ?
            ...
            ("px" === h || c || (u = Bd(t, e, r, "px")),
                ...
                ((l[f ? "width" : "height"] = 100 + (c ? h : i)),
                    (a = ~e.indexOf("adius") || ("em" === i && t.appendChild && !d) ?
                        t :
                        t.parentNode),
